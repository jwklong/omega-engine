...
<p>You have {{formatNumber(layer.resource, 2, 0, 1e9)}} <resource-name :layerid="layer.layer"></resource-name> crewmates</p>
<p>You have made a total of {{formatNumber(layer.totalResource, 2, 0, 1e9)}} crewmates on <resource-name :layerid="layer.layer"></resource-name></p>
<p>The highest you ever had is {{formatNumber(layer.maxResource, 2, 0, 1e9)}} <resource-name :layerid="layer.layer"></resource-name> crewmates</p>
